...
def add_product(request):
    if request.method == 'POST':
        ...
        prod_quantity = request.POST.get("p-qnty")
        ...
        query = Product(name=prod_name, qnty=prod_quantity, size=prod_size, price=prod_price)
        query.save()
